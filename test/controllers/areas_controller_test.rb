...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: { application_id: @area.application_id, description: @area.description, name: @area.name }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: { application_id: @area.application_id, description: @area.description, name: @area.name }
    assert_redirected_to area_path(assigns(:area))
  end
