...
class ColumnsControllerTest < ActionController::TestCase
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post :create, column: { description: @column.description, name: @column.name, table_id: @column.table_id }
    end
  ...
  test "should update column" do
    patch :update, id: @column, column: { description: @column.description, name: @column.name, table_id: @column.table_id }
    assert_redirected_to column_path(assigns(:column))
  end
