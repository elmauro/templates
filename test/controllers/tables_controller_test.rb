...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { description: @table.description, name: @table.name, table_id: @table.table_id, tabular: @table.tabular, template_id: @table.template_id }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { description: @table.description, name: @table.name, table_id: @table.table_id, tabular: @table.tabular, template_id: @table.template_id }
    assert_redirected_to table_path(assigns(:table))
  end
